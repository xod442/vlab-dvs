...
def makedvs(vnic,cluster_id,dvs_name,vsphere_ip,vsphere_user,vsphere_pass,datacenter_name):
    ...
    cluster = get_obj(content, [vim.ClusterComputeResource],cluster_id)
...
def create_dvSwitch(si, content, network_folder, cluster, dvs_name, vnic):
    ...
    response = wait_for_task(task, si, dvs_name)
